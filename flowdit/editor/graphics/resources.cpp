module flowdit.editor.graphics.resources;
import std;
import vulkan;
namespace flowdit::editor::graphics {
    ...
    Image::Image(Device& device, const vk::Extent2D dimensions, const vk::Format type) : extent{dimensions}, format{type} {
        image                  = vk::raii::Image{device.logical, vk::ImageCreateInfo{{}, vk::ImageType::e2D, type, {extent.width, extent.height, 1}, 1, 1, vk::SampleCountFlagBits::e1, vk::ImageTiling::eOptimal, vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eTransferDst | vk::ImageUsageFlagBits::eTransferSrc, vk::SharingMode::eExclusive}};
