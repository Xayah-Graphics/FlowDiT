...
namespace flowdit {
    ...
    void SamplingRuntime::initialize(const SamplingRequest& source) {
        ...
        kernels::make_labels(stream, labels.data(), batch, request.class_index.value_or(UINT32_MAX), model.configuration.class_count);
    }
